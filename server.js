...
function initProducts() {
    ...
    if (products.length === 0) {
        const myProducts = [
            ...
            {id:Date.now()+8,name:"Geneva men watch",category:"Watches",gender:"Male",price:2750,stock:999,description:"Men's Wrist Watch With Calendar Function",images:["https://i.ibb.co/GQQHg7ff/Gemini-Generated-Image-9kft8m9kft8m9kft.png"],is_sold:false,is_hidden:false,created_at:new Date().toISOString()},
            {id:Date.now()+9,name:"Watch",category:"Watches",gender:"Male",price:2100,stock:999,description:"Men Watch, Minimalist Design",images:["https://i.ibb.co/Q32qBHYD/Gemini-Generated-Image-ooo10rooo10rooo1.png"],is_sold:false,is_hidden:false,created_at:new Date().toISOString()},
            {id:Date.now()+10,name:"Hand bag for women",category:"Bags",gender:"Female",price:3950,stock:999,description:"Available in different materials and colors",images:["https://i.ibb.co/4vvXdpm/photo-2026-06-29-18-32-01.jpg"],is_sold:false,is_hidden:false,created_at:new Date().toISOString()},
            ...
            {id:Date.now()+33,name:"Sweat pants",category:"Clothes",gender:"Female",price:3950,stock:999,description:"Wide leg sweat pants",images:["https://i.ibb.co/Kzy1brwg/photo-2026-07-01-10-26-01.jpg"],is_sold:false,is_hidden:false,created_at:new Date().toISOString()},
            ...
            {id:Date.now()+43,name:"Women's watch and jewelry set",category:"Watches",gender:"Female",price:2200,stock:999,description:"Comes with necklace, ring, earrings, bracelet and watch",images:["https://i.ibb.co/HMVtXdG/photo-2026-06-30-15-26-20.jpg"],is_sold:false,is_hidden:false,created_at:new Date().toISOString()},
            ...
            {id:Date.now()+48,name:"Foam Clogs (Crocs)",category:"Shoes",gender:"Unisex",price:3000,stock:999,description:"ITEM MAY NOT BE LIKE THE PICTURE",images:["https://i.ibb.co/Y4YYcZk1/Gemini-Generated-Image-k5pp6bk5pp6bk5pp.png"],is_sold:false,is_hidden:false,created_at:new Date().toISOString()},
            {id:Date.now()+49,name:"Belt",category:"Clothes",gender:"Male",price:2300,stock:999,description:"Available in different design",images:["https://i.ibb.co/1fP97KXy/photo-2026-06-30-15-21-31.jpg"],is_sold:false,is_hidden:false,created_at:new Date().toISOString()}
        ];
